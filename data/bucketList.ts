...
export type BucketKategori = "gezi" | "yemek" | "aktivite" | "hayal" | "diger";
...
export function kategoriBilgisi(kategori: BucketKategori): BucketKategoriBilgi {
  return BUCKET_KATEGORILERI.find((k) => k.id === kategori) ?? BUCKET_KATEGORILERI[4];
}
